    ...
    <div className='App-contact'>
        ...
        <div className="contacts">
            <div className="contact-info">
                <p>Our Address: <br /> <br /> SoE Block II, Malla Reddy University, <br /> Maisammaguda, Dulapally, Hyderabad, Telangana 500043</p>
                <br /><p>Email: nispmruh@mallareddyuniversity.ac.in</p>
                <p>Location:</p>
