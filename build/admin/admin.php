...
<div class="container">
    ...
    <div id="profile">
        ...
        <div class="buttons">
            ...
            <div class="form-btn">
                <a href="verify_payment.php" class="btn btn-primary">Verify Payments</a>
            </div>
        </div>
        <br>
        <h4>Student Coordinator Management</h4>
        <div class="buttons">
            <div class="form-btn">
                <a class="btn btn-primary" href="studentco_data.php">Student Co Data</a>
            </div>
            <div class="form-btn">
                <a href="studentco_register.php" class="btn btn-primary">Register Student Co</a>
            </div>
            <div class="form-btn">
                <a href="studentco_edit.php" class="btn btn-primary">Edit Student Co Data</a>
            </div>
        </div>
        <br>
    </div>
